        ...
        <div class="grid">
          <div class="card">
            ...
            <div class="metric">
              ...
              <span class="metric-value" id="total-jobs">-</span>
            </div>
          </div>
          ...
          <div class="card">
            <h2>Catalog Stats</h2>
            <div class="metric">
              <span class="metric-label">Total Songs</span>
              <span class="metric-value" id="total-songs">-</span>
            </div>
            <div class="metric">
              <span class="metric-label">Total Playlists</span>
              <span class="metric-value" id="total-playlists">-</span>
            </div>
            <div class="metric">
              <span class="metric-label">Processing</span>
              <span class="metric-value" id="processing-songs">-</span>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="metric">
              ...
              <span class="metric-value" id="stat-queued">-</span>
            </div>
            <div class="metric">
              <span class="metric-label">Running</span>
              <span class="metric-value" id="stat-running">-</span>
            </div>
            <div class="metric">
              <span class="metric-label">Done</span>
              <span class="metric-value" id="stat-done">-</span>
            </div>
            <div class="metric">
              <span class="metric-label">Failed</span>
              <span class="metric-value" id="stat-failed">-</span>
            </div>
          </div>
        </div>
      </div>
        ...
        async function fetchStats() {
          try {
            const [statsRes, songsRes, playlistsRes, currentRes, jobsRes] = await Promise.all([
              ...
              fetch('/songs'),
              fetch('/playlists'),
              fetch('/player/current'),
              fetch('/jobs?status=running')
            ]);
